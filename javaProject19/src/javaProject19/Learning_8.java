...
public class Learning_8 extends JFrame {
	...
	public Learning_8() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\LG\\Desktop\\girin.png"));
		lblNewLabel.setBounds(63, 67, 110, 132);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("기린");
		lblNewLabel_1.setBounds(226, 105, 57, 15);
		contentPane.add(lblNewLabel_1);
		
		JLabel label_1 = new JLabel("목이 길다!");
		label_1.setBounds(226, 145, 80, 15);
