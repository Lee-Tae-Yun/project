...
public class AnswerSubmit_9 extends JFrame {

	private JPanel contentPane;

	public AnswerSubmit_9() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\LG\\Desktop\\monkey.png"));
		label.setBounds(91, 62, 103, 109);
		contentPane.add(label);
		
		JLabel label_1 = new JLabel("원숭이");
		...
		button.setBounds(221, 193, 97, 23);
		...
		btnNewButton.setBounds(97, 193, 97, 23);
