...
public class Test_11 extends JFrame {
	...
	public Test_11() {
		...
		label_1.setIcon(new ImageIcon("C:\\Users\\LG\\Desktop\\podol.png"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(An.equals("호랑이")) {
				AnswerSubmit_13 p1 = new AnswerSubmit_13();
				p1.setVisible(true);
				dispose();
				}
				else {
					Answer_12 p1 = new Answer_12();
					p1.setVisible(true);
					dispose();
				}
			}
		...
		JButton button_1 = new JButton("레벨업!");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String An = textField.getText();
				if(An.equals("")){
				JOptionPane.showMessageDialog(null, "정답을 입력후 눌러주세요!");
				}
				else if(An.equals("호랑이")) {
				...
				dispose();
					...
					JOptionPane.showMessageDialog(null, "Level Up Fail");
				}
		...
		button_1.setBounds(79, 189, 111, 23);
		...
		button_2.setBounds(234, 189, 108, 23);
