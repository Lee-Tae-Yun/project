...
public class Learning_6 extends JFrame {
	...
	public Learning_6() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\LG\\Desktop\\podol.png"));
		lblNewLabel.setBounds(63, 67, 110, 132);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("호랑이");
		lblNewLabel_1.setBounds(226, 105, 57, 15);
		contentPane.add(lblNewLabel_1);
		
		JLabel label_1 = new JLabel("어흥!");
