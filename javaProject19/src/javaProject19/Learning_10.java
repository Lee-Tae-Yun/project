...
public class Learning_10 extends JFrame {
	...
	public Learning_10() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\LG\\Desktop\\cat.png"));
		lblNewLabel.setBounds(63, 67, 110, 132);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("고양이");
		lblNewLabel_1.setBounds(226, 105, 57, 15);
		contentPane.add(lblNewLabel_1);
		
		JLabel label_1 = new JLabel("\uCEAC\uC639!");
		label_1.setBounds(226, 145, 57, 15);
		contentPane.add(label_1);
		
		JButton btnNewButton = new JButton("학습종료");
