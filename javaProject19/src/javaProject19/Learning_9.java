...
public class Learning_9 extends JFrame {
	...
	public Learning_9() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\LG\\Desktop\\monkey.png"));
		lblNewLabel.setBounds(63, 67, 110, 132);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("원숭이");
		lblNewLabel_1.setBounds(226, 105, 57, 15);
		contentPane.add(lblNewLabel_1);
		
		JLabel label_1 = new JLabel("우끼끼!");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Learning_10 p1 = new Learning_10();
				p1.setVisible(true);
				dispose();
			}
		});
